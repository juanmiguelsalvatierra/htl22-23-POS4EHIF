	...
	// write your code here
        ...
        Random rnd=new Random();
            ...
            for (int j = 0; j < 100; j++) {
                ...
                waren[i+1][j]=new Spielwaren(rnd.nextInt(1498), rnd.nextInt((int)69.5),rnd.nextInt(3) );
                waren[i+2][j]=new Haushaltsartikel(rnd.nextInt((int)1498.0), rnd.nextInt((int)69.5), rnd.nextBoolean());
            }
            rnd.nextInt((int)3.5);
